...
| Part | Mass |
|---|---|
| Frame (CX10 ECO) | 0.38 kg (reseller listing; not on the maker's cited page) |
...
- **Thrust:** 4 × S3115 900 KV on 6S with 10" 3-blade props gives an assumed realistic maximum of about 2.5–3.2 kgf per motor, well below the listed 4.2 kgf peak. That's about 10–13 kgf in total, a **thrust-to-weight of about 2–2.6 at take-off**. The physics engineer derives the exact curve.
