...
- [x] 2.4 [physics-engineer] Fold `pilot-answers.md` into `wind.md`:
  ...
  - the mass range
  - the clip as the worst stretch of a longer flight
...
- [x] 2.5 [physics-engineer] Re-derive the take-off mass, inertia, thrust curve and margin, and the airspeed and crosswind estimates from the reference-class specs and the pilot's battery class in `docs/reference-notes/airframes.md`. Check the airspeed against the class's published cruise speed. Update §5 and §6 wherever they depend on mass. Verify that every changed number reproduces
